...
import static tn.adhes.hemophilie.web.rest.TestUtil.createUpdateProxyForBean;
...
import tn.adhes.hemophilie.IntegrationTest;
...
class FicheHemophilieResourceIT {
    ...
    private static final OuiNonNP DEFAULT_EXPLORATION_SYNDROME = OuiNonNP.OUI;
    private static final OuiNonNP UPDATED_EXPLORATION_SYNDROME = OuiNonNP.NON;
    ...
    private static final OuiNonNP DEFAULT_TS = OuiNonNP.OUI;
    private static final OuiNonNP UPDATED_TS = OuiNonNP.NON;

    private static final OuiNonNP DEFAULT_PFA = OuiNonNP.OUI;
    private static final OuiNonNP UPDATED_PFA = OuiNonNP.NON;
    ...
    private static final TypeHemorragie DEFAULT_HEMARTHROSE_TYPE = TypeHemorragie.CHUTE_DENTAIRE;
    private static final TypeHemorragie UPDATED_HEMARTHROSE_TYPE = TypeHemorragie.PLAIE_LANGUE;
    ...
    private static final TypeHemorragie DEFAULT_HEMATOME_SUPERFICIEL_TYPE = TypeHemorragie.CHUTE_DENTAIRE;
    private static final TypeHemorragie UPDATED_HEMATOME_SUPERFICIEL_TYPE = TypeHemorragie.PLAIE_LANGUE;
    ...
    private static final Boolean DEFAULT_MARIE = false;
    private static final Boolean UPDATED_MARIE = true;

    private static final Boolean DEFAULT_ENFANTS = false;
    private static final Boolean UPDATED_ENFANTS = true;

    private static final Boolean DEFAULT_HANDICAP = false;
    private static final Boolean UPDATED_HANDICAP = true;
    ...
    public static FicheHemophilie createEntity() {
        return new FicheHemophilie()
            ...
            .explorationSyndrome(DEFAULT_EXPLORATION_SYNDROME)
    ...
    void getAllFicheHemophilies() throws Exception {
        ...
        restFicheHemophilieMockMvc
            ...
            .andExpect(jsonPath("$.[*].explorationSyndrome").value(hasItem(DEFAULT_EXPLORATION_SYNDROME.toString())))
            ...
            .andExpect(jsonPath("$.[*].marie").value(hasItem(DEFAULT_MARIE.booleanValue())))
            .andExpect(jsonPath("$.[*].enfants").value(hasItem(DEFAULT_ENFANTS.booleanValue())))
            .andExpect(jsonPath("$.[*].handicap").value(hasItem(DEFAULT_HANDICAP.booleanValue())))
    ...
    void getFicheHemophilie() throws Exception {
        ...
        restFicheHemophilieMockMvc
            ...
            .andExpect(jsonPath("$.explorationSyndrome").value(DEFAULT_EXPLORATION_SYNDROME.toString()))
            ...
            .andExpect(jsonPath("$.marie").value(DEFAULT_MARIE.booleanValue()))
            .andExpect(jsonPath("$.enfants").value(DEFAULT_ENFANTS.booleanValue()))
            .andExpect(jsonPath("$.handicap").value(DEFAULT_HANDICAP.booleanValue()))
