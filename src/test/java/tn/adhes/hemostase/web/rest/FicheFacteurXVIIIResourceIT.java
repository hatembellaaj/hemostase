...
/**
 * Integration tests for the {@link FicheFacteurXVIIIResource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class FicheFacteurXVIIIResourceIT {
    ...
    private static final Boolean DEFAULT_CIRC_HEMORRAGIQUE = false;
    private static final Boolean UPDATED_CIRC_HEMORRAGIQUE = true;

    private static final String DEFAULT_PRECISIONS_CIRC_HEMORRAGIQUE = "AAAAAAAAAA";
    private static final String UPDATED_PRECISIONS_CIRC_HEMORRAGIQUE = "BBBBBBBBBB";

    private static final Boolean DEFAULT_DECOUVERTE_FORTUITE_PREOP = false;
    private static final Boolean UPDATED_DECOUVERTE_FORTUITE_PREOP = true;

    private static final String DEFAULT_PRECISIONS_DECOUVERTE_FORTUITE = "AAAAAAAAAA";
    private static final String UPDATED_PRECISIONS_DECOUVERTE_FORTUITE = "BBBBBBBBBB";

    private static final OuiNonNP DEFAULT_JAMAIS_SAIGNEMENT = OuiNonNP.OUI;
    private static final OuiNonNP UPDATED_JAMAIS_SAIGNEMENT = OuiNonNP.NON;

    private static final Integer DEFAULT_AGE_PREMIER_SIGNE_JOURS = 1;
    private static final Integer UPDATED_AGE_PREMIER_SIGNE_JOURS = 2;

    private static final Integer DEFAULT_AGE_PREMIER_SIGNE_MOIS = 1;
    private static final Integer UPDATED_AGE_PREMIER_SIGNE_MOIS = 2;

    private static final Integer DEFAULT_AGE_PREMIER_SIGNE_ANNEES = 1;
    private static final Integer UPDATED_AGE_PREMIER_SIGNE_ANNEES = 2;
    ...
    private static final Boolean DEFAULT_SYMPTOME_POST_AMYGDALECTOMIE = false;
    private static final Boolean UPDATED_SYMPTOME_POST_AMYGDALECTOMIE = true;

    private static final Boolean DEFAULT_SYMPTOME_POST_AVULSION_DENTAIRE = false;
    private static final Boolean UPDATED_SYMPTOME_POST_AVULSION_DENTAIRE = true;

    private static final Boolean DEFAULT_SYMPTOME_CHUTE_CORDON = false;
    private static final Boolean UPDATED_SYMPTOME_CHUTE_CORDON = true;
    ...
    private static final String DEFAULT_FACTEUR_DEFICITAIRE_AUTRE = "AAAAAAAAAA";
    private static final String UPDATED_FACTEUR_DEFICITAIRE_AUTRE = "BBBBBBBBBB";

    private static final Double DEFAULT_TAUX_FACTEUR_DEFICITAIRE_AUTRE = 1D;
    private static final Double UPDATED_TAUX_FACTEUR_DEFICITAIRE_AUTRE = 2D;

    private static final String DEFAULT_FACTEUR_SUPPLEMENTAIRE_1 = "AAAAAAAAAA";
    private static final String UPDATED_FACTEUR_SUPPLEMENTAIRE_1 = "BBBBBBBBBB";

    private static final Double DEFAULT_TAUX_SUPPLEMENTAIRE_1 = 1D;
    private static final Double UPDATED_TAUX_SUPPLEMENTAIRE_1 = 2D;

    private static final String DEFAULT_FACTEUR_SUPPLEMENTAIRE_2 = "AAAAAAAAAA";
    private static final String UPDATED_FACTEUR_SUPPLEMENTAIRE_2 = "BBBBBBBBBB";

    private static final Double DEFAULT_TAUX_SUPPLEMENTAIRE_2 = 1D;
    private static final Double UPDATED_TAUX_SUPPLEMENTAIRE_2 = 2D;

    private static final String DEFAULT_FACTEUR_SUPPLEMENTAIRE_3 = "AAAAAAAAAA";
    private static final String UPDATED_FACTEUR_SUPPLEMENTAIRE_3 = "BBBBBBBBBB";

    private static final Double DEFAULT_TAUX_SUPPLEMENTAIRE_3 = 1D;
    private static final Double UPDATED_TAUX_SUPPLEMENTAIRE_3 = 2D;

    private static final OuiNonNP DEFAULT_CONFIRMATION_MOLECULAIRE = OuiNonNP.OUI;
    private static final OuiNonNP UPDATED_CONFIRMATION_MOLECULAIRE = OuiNonNP.NON;
    ...
    private static final SerologieStatut DEFAULT_SEROLOGIE_VHB = SerologieStatut.POSITIVE;
    private static final SerologieStatut UPDATED_SEROLOGIE_VHB = SerologieStatut.NEGATIVE;

    private static final SerologieStatut DEFAULT_SEROLOGIE_VHC = SerologieStatut.POSITIVE;
    private static final SerologieStatut UPDATED_SEROLOGIE_VHC = SerologieStatut.NEGATIVE;

    private static final SerologieStatut DEFAULT_SEROLOGIE_VIH = SerologieStatut.POSITIVE;
    private static final SerologieStatut UPDATED_SEROLOGIE_VIH = SerologieStatut.NEGATIVE;
    ...
    private static final String ENTITY_API_URL = "/api/fiche-facteur-xviiis";
    ...
    @Autowired
    private FicheFacteurXVIIIRepository ficheFacteurXVIIIRepository;
    ...
    @Autowired
    private MockMvc restFicheFacteurXVIIIMockMvc;

    private FicheFacteurXVIII ficheFacteurXVIII;

    private FicheFacteurXVIII insertedFicheFacteurXVIII;
     ...
     */
    public static FicheFacteurXVIII createEntity() {
        return new FicheFacteurXVIII()
            ...
            .circHemorragique(DEFAULT_CIRC_HEMORRAGIQUE)
            .precisionsCircHemorragique(DEFAULT_PRECISIONS_CIRC_HEMORRAGIQUE)
            .decouverteFortuitePreop(DEFAULT_DECOUVERTE_FORTUITE_PREOP)
            .precisionsDecouverteFortuite(DEFAULT_PRECISIONS_DECOUVERTE_FORTUITE)
            .jamaisSaignement(DEFAULT_JAMAIS_SAIGNEMENT)
            .agePremierSigneJours(DEFAULT_AGE_PREMIER_SIGNE_JOURS)
            .agePremierSigneMois(DEFAULT_AGE_PREMIER_SIGNE_MOIS)
            .agePremierSigneAnnees(DEFAULT_AGE_PREMIER_SIGNE_ANNEES)
            ...
            .symptomePostAmygdalectomie(DEFAULT_SYMPTOME_POST_AMYGDALECTOMIE)
            .symptomePostAvulsionDentaire(DEFAULT_SYMPTOME_POST_AVULSION_DENTAIRE)
            .symptomeChuteCordon(DEFAULT_SYMPTOME_CHUTE_CORDON)
            ...
            .facteurDeficitaireAutre(DEFAULT_FACTEUR_DEFICITAIRE_AUTRE)
            .tauxFacteurDeficitaireAutre(DEFAULT_TAUX_FACTEUR_DEFICITAIRE_AUTRE)
            .facteurSupplementaire1(DEFAULT_FACTEUR_SUPPLEMENTAIRE_1)
            .tauxSupplementaire1(DEFAULT_TAUX_SUPPLEMENTAIRE_1)
            .facteurSupplementaire2(DEFAULT_FACTEUR_SUPPLEMENTAIRE_2)
            .tauxSupplementaire2(DEFAULT_TAUX_SUPPLEMENTAIRE_2)
            .facteurSupplementaire3(DEFAULT_FACTEUR_SUPPLEMENTAIRE_3)
            .tauxSupplementaire3(DEFAULT_TAUX_SUPPLEMENTAIRE_3)
     ...
     * if they test an entity which requires the current entity.
     */
    public static FicheFacteurXVIII createUpdatedEntity() {
        return new FicheFacteurXVIII()
            ...
            .circHemorragique(UPDATED_CIRC_HEMORRAGIQUE)
            .precisionsCircHemorragique(UPDATED_PRECISIONS_CIRC_HEMORRAGIQUE)
            .decouverteFortuitePreop(UPDATED_DECOUVERTE_FORTUITE_PREOP)
            .precisionsDecouverteFortuite(UPDATED_PRECISIONS_DECOUVERTE_FORTUITE)
            .jamaisSaignement(UPDATED_JAMAIS_SAIGNEMENT)
            .agePremierSigneJours(UPDATED_AGE_PREMIER_SIGNE_JOURS)
            .agePremierSigneMois(UPDATED_AGE_PREMIER_SIGNE_MOIS)
            .agePremierSigneAnnees(UPDATED_AGE_PREMIER_SIGNE_ANNEES)
            ...
            .symptomePostAmygdalectomie(UPDATED_SYMPTOME_POST_AMYGDALECTOMIE)
            .symptomePostAvulsionDentaire(UPDATED_SYMPTOME_POST_AVULSION_DENTAIRE)
            .symptomeChuteCordon(UPDATED_SYMPTOME_CHUTE_CORDON)
            ...
            .facteurDeficitaireAutre(UPDATED_FACTEUR_DEFICITAIRE_AUTRE)
            .tauxFacteurDeficitaireAutre(UPDATED_TAUX_FACTEUR_DEFICITAIRE_AUTRE)
            .facteurSupplementaire1(UPDATED_FACTEUR_SUPPLEMENTAIRE_1)
            .tauxSupplementaire1(UPDATED_TAUX_SUPPLEMENTAIRE_1)
            .facteurSupplementaire2(UPDATED_FACTEUR_SUPPLEMENTAIRE_2)
            .tauxSupplementaire2(UPDATED_TAUX_SUPPLEMENTAIRE_2)
            .facteurSupplementaire3(UPDATED_FACTEUR_SUPPLEMENTAIRE_3)
            .tauxSupplementaire3(UPDATED_TAUX_SUPPLEMENTAIRE_3)
    ...
    public void initTest() {
        ficheFacteurXVIII = createEntity();
    }

    @AfterEach
    public void cleanup() {
        if (insertedFicheFacteurXVIII != null) {
            ficheFacteurXVIIIRepository.delete(insertedFicheFacteurXVIII);
            insertedFicheFacteurXVIII = null;
        }
    }

    @Test
    @Transactional
    void createFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeCreate = getRepositoryCount();
        // Create the FicheFacteurXVIII
        FicheFacteurXVIIIDTO ficheFacteurXVIIIDTO = ficheFacteurXVIIIMapper.toDto(ficheFacteurXVIII);
        var returnedFicheFacteurXVIIIDTO = om.readValue(
            restFicheFacteurXVIIIMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ficheFacteurXVIIIDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            FicheFacteurXVIIIDTO.class
        );

        // Validate the FicheFacteurXVIII in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedFicheFacteurXVIII = ficheFacteurXVIIIMapper.toEntity(returnedFicheFacteurXVIIIDTO);
        assertFicheFacteurXVIIIUpdatableFieldsEquals(returnedFicheFacteurXVIII, getPersistedFicheFacteurXVIII(returnedFicheFacteurXVIII));

        insertedFicheFacteurXVIII = returnedFicheFacteurXVIII;
    }

    @Test
    @Transactional
    void createFicheFacteurXVIIIWithExistingId() throws Exception {
        // Create the FicheFacteurXVIII with an existing ID
        ficheFacteurXVIII.setId(1L);
        FicheFacteurXVIIIDTO ficheFacteurXVIIIDTO = ficheFacteurXVIIIMapper.toDto(ficheFacteurXVIII);
    ...
    void checkEtatCivilIsRequired() throws Exception {
        ...
        // set the field null
        ficheFacteurXVIII.setEtatCivil(null);

        // Create the FicheFacteurXVIII, which fails.
        FicheFacteurXVIIIDTO ficheFacteurXVIIIDTO = ficheFacteurXVIIIMapper.toDto(ficheFacteurXVIII);
    ...
    void checkServiceCliniqueIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurXVIII.setServiceClinique(null);
    ...
    void checkCouvertureSocialeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurXVIII.setCouvertureSociale(null);
    ...
    void checkSexeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurXVIII.setSexe(null);
    ...
    void checkDiagnosticIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurXVIII.setDiagnostic(null);
    ...
    @Test
    @Transactional
    void getAllFicheFacteurXVIIIS() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);

        // Get all the ficheFacteurXVIIIList
        restFicheFacteurXVIIIMockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(ficheFacteurXVIII.getId().intValue())))
            ...
            .andExpect(jsonPath("$.[*].circHemorragique").value(hasItem(DEFAULT_CIRC_HEMORRAGIQUE.booleanValue())))
            .andExpect(jsonPath("$.[*].precisionsCircHemorragique").value(hasItem(DEFAULT_PRECISIONS_CIRC_HEMORRAGIQUE)))
            .andExpect(jsonPath("$.[*].decouverteFortuitePreop").value(hasItem(DEFAULT_DECOUVERTE_FORTUITE_PREOP.booleanValue())))
            .andExpect(jsonPath("$.[*].precisionsDecouverteFortuite").value(hasItem(DEFAULT_PRECISIONS_DECOUVERTE_FORTUITE)))
            .andExpect(jsonPath("$.[*].jamaisSaignement").value(hasItem(DEFAULT_JAMAIS_SAIGNEMENT.toString())))
            .andExpect(jsonPath("$.[*].agePremierSigneJours").value(hasItem(DEFAULT_AGE_PREMIER_SIGNE_JOURS)))
            .andExpect(jsonPath("$.[*].agePremierSigneMois").value(hasItem(DEFAULT_AGE_PREMIER_SIGNE_MOIS)))
            .andExpect(jsonPath("$.[*].agePremierSigneAnnees").value(hasItem(DEFAULT_AGE_PREMIER_SIGNE_ANNEES)))
            ...
            .andExpect(jsonPath("$.[*].symptomePostAmygdalectomie").value(hasItem(DEFAULT_SYMPTOME_POST_AMYGDALECTOMIE.booleanValue())))
            .andExpect(
                jsonPath("$.[*].symptomePostAvulsionDentaire").value(hasItem(DEFAULT_SYMPTOME_POST_AVULSION_DENTAIRE.booleanValue()))
            )
            .andExpect(jsonPath("$.[*].symptomeChuteCordon").value(hasItem(DEFAULT_SYMPTOME_CHUTE_CORDON.booleanValue())))
            ...
            .andExpect(jsonPath("$.[*].facteurDeficitaireAutre").value(hasItem(DEFAULT_FACTEUR_DEFICITAIRE_AUTRE)))
            .andExpect(jsonPath("$.[*].tauxFacteurDeficitaireAutre").value(hasItem(DEFAULT_TAUX_FACTEUR_DEFICITAIRE_AUTRE.doubleValue())))
            .andExpect(jsonPath("$.[*].facteurSupplementaire1").value(hasItem(DEFAULT_FACTEUR_SUPPLEMENTAIRE_1)))
            .andExpect(jsonPath("$.[*].tauxSupplementaire1").value(hasItem(DEFAULT_TAUX_SUPPLEMENTAIRE_1.doubleValue())))
            .andExpect(jsonPath("$.[*].facteurSupplementaire2").value(hasItem(DEFAULT_FACTEUR_SUPPLEMENTAIRE_2)))
            .andExpect(jsonPath("$.[*].tauxSupplementaire2").value(hasItem(DEFAULT_TAUX_SUPPLEMENTAIRE_2.doubleValue())))
            .andExpect(jsonPath("$.[*].facteurSupplementaire3").value(hasItem(DEFAULT_FACTEUR_SUPPLEMENTAIRE_3)))
            .andExpect(jsonPath("$.[*].tauxSupplementaire3").value(hasItem(DEFAULT_TAUX_SUPPLEMENTAIRE_3.doubleValue())))
    ...
    @Test
    @Transactional
    void getFicheFacteurXVIII() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);

        // Get the ficheFacteurXVIII
        restFicheFacteurXVIIIMockMvc
            .perform(get(ENTITY_API_URL_ID, ficheFacteurXVIII.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(ficheFacteurXVIII.getId().intValue()))
            ...
            .andExpect(jsonPath("$.circHemorragique").value(DEFAULT_CIRC_HEMORRAGIQUE.booleanValue()))
            .andExpect(jsonPath("$.precisionsCircHemorragique").value(DEFAULT_PRECISIONS_CIRC_HEMORRAGIQUE))
            .andExpect(jsonPath("$.decouverteFortuitePreop").value(DEFAULT_DECOUVERTE_FORTUITE_PREOP.booleanValue()))
            .andExpect(jsonPath("$.precisionsDecouverteFortuite").value(DEFAULT_PRECISIONS_DECOUVERTE_FORTUITE))
            .andExpect(jsonPath("$.jamaisSaignement").value(DEFAULT_JAMAIS_SAIGNEMENT.toString()))
            .andExpect(jsonPath("$.agePremierSigneJours").value(DEFAULT_AGE_PREMIER_SIGNE_JOURS))
            .andExpect(jsonPath("$.agePremierSigneMois").value(DEFAULT_AGE_PREMIER_SIGNE_MOIS))
            .andExpect(jsonPath("$.agePremierSigneAnnees").value(DEFAULT_AGE_PREMIER_SIGNE_ANNEES))
            ...
            .andExpect(jsonPath("$.symptomePostAmygdalectomie").value(DEFAULT_SYMPTOME_POST_AMYGDALECTOMIE.booleanValue()))
            .andExpect(jsonPath("$.symptomePostAvulsionDentaire").value(DEFAULT_SYMPTOME_POST_AVULSION_DENTAIRE.booleanValue()))
            .andExpect(jsonPath("$.symptomeChuteCordon").value(DEFAULT_SYMPTOME_CHUTE_CORDON.booleanValue()))
            ...
            .andExpect(jsonPath("$.facteurDeficitaireAutre").value(DEFAULT_FACTEUR_DEFICITAIRE_AUTRE))
            .andExpect(jsonPath("$.tauxFacteurDeficitaireAutre").value(DEFAULT_TAUX_FACTEUR_DEFICITAIRE_AUTRE.doubleValue()))
            .andExpect(jsonPath("$.facteurSupplementaire1").value(DEFAULT_FACTEUR_SUPPLEMENTAIRE_1))
            .andExpect(jsonPath("$.tauxSupplementaire1").value(DEFAULT_TAUX_SUPPLEMENTAIRE_1.doubleValue()))
            .andExpect(jsonPath("$.facteurSupplementaire2").value(DEFAULT_FACTEUR_SUPPLEMENTAIRE_2))
            .andExpect(jsonPath("$.tauxSupplementaire2").value(DEFAULT_TAUX_SUPPLEMENTAIRE_2.doubleValue()))
            .andExpect(jsonPath("$.facteurSupplementaire3").value(DEFAULT_FACTEUR_SUPPLEMENTAIRE_3))
            .andExpect(jsonPath("$.tauxSupplementaire3").value(DEFAULT_TAUX_SUPPLEMENTAIRE_3.doubleValue()))
    ...
    @Test
    @Transactional
    void getNonExistingFicheFacteurXVIII() throws Exception {
        // Get the ficheFacteurXVIII
        restFicheFacteurXVIIIMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingFicheFacteurXVIII() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the ficheFacteurXVIII
        FicheFacteurXVIII updatedFicheFacteurXVIII = ficheFacteurXVIIIRepository.findById(ficheFacteurXVIII.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedFicheFacteurXVIII are not directly saved in db
        em.detach(updatedFicheFacteurXVIII);
        updatedFicheFacteurXVIII
            .dossierNumber(UPDATED_DOSSIER_NUMBER)
            .ordreNumber(UPDATED_ORDRE_NUMBER)
            .indexNumber(UPDATED_INDEX_NUMBER)
            .prenom(UPDATED_PRENOM)
            ...
            .ageDeces(UPDATED_AGE_DECES)
            .causeDeces(UPDATED_CAUSE_DECES);
        FicheFacteurXVIIIDTO ficheFacteurXVIIIDTO = ficheFacteurXVIIIMapper.toDto(updatedFicheFacteurXVIII);

        restFicheFacteurXVIIIMockMvc
            .perform(
                put(ENTITY_API_URL_ID, ficheFacteurXVIIIDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(ficheFacteurXVIIIDTO))
            )
            .andExpect(status().isOk());

        // Validate the FicheFacteurXVIII in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedFicheFacteurXVIIIToMatchAllProperties(updatedFicheFacteurXVIII);
    }

    @Test
    @Transactional
    void putNonExistingFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithIdMismatchFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFicheFacteurXVIIIMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ficheFacteurXVIIIDTO)))
    ...
    @Test
    @Transactional
    void partialUpdateFicheFacteurXVIIIWithPatch() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the ficheFacteurXVIII using partial update
        FicheFacteurXVIII partialUpdatedFicheFacteurXVIII = new FicheFacteurXVIII();
        partialUpdatedFicheFacteurXVIII.setId(ficheFacteurXVIII.getId());

        partialUpdatedFicheFacteurXVIII
            .indexNumber(UPDATED_INDEX_NUMBER)
            .nom(UPDATED_NOM)
            .serviceClinique(UPDATED_SERVICE_CLINIQUE)
            .autreServiceClinique(UPDATED_AUTRE_SERVICE_CLINIQUE)
        ...
        restFicheFacteurXVIIIMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedFicheFacteurXVIII.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedFicheFacteurXVIII))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertFicheFacteurXVIIIUpdatableFieldsEquals(
            createUpdateProxyForBean(partialUpdatedFicheFacteurXVIII, ficheFacteurXVIII),
            getPersistedFicheFacteurXVIII(ficheFacteurXVIII)
        );
    }

    @Test
    @Transactional
    void fullUpdateFicheFacteurXVIIIWithPatch() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);
        ...
        assertFicheFacteurXVIIIUpdatableFieldsEquals(
            partialUpdatedFicheFacteurXVIII,
            getPersistedFicheFacteurXVIII(partialUpdatedFicheFacteurXVIII)
        );
    }

    @Test
    @Transactional
    void patchNonExistingFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
        ...
        restFicheFacteurXVIIIMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, ficheFacteurXVIIIDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(ficheFacteurXVIIIDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamFicheFacteurXVIII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurXVIII.setId(longCount.incrementAndGet());
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFicheFacteurXVIIIMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(ficheFacteurXVIIIDTO)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteFicheFacteurXVIII() throws Exception {
        // Initialize the database
        insertedFicheFacteurXVIII = ficheFacteurXVIIIRepository.saveAndFlush(ficheFacteurXVIII);

        long databaseSizeBeforeDelete = getRepositoryCount();

        // Delete the ficheFacteurXVIII
        restFicheFacteurXVIIIMockMvc
            .perform(delete(ENTITY_API_URL_ID, ficheFacteurXVIII.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected long getRepositoryCount() {
        return ficheFacteurXVIIIRepository.count();
    }
    ...
    protected FicheFacteurXVIII getPersistedFicheFacteurXVIII(FicheFacteurXVIII ficheFacteurXVIII) {
        return ficheFacteurXVIIIRepository.findById(ficheFacteurXVIII.getId()).orElseThrow();
    }

    protected void assertPersistedFicheFacteurXVIIIToMatchAllProperties(FicheFacteurXVIII expectedFicheFacteurXVIII) {
        assertFicheFacteurXVIIIAllPropertiesEquals(expectedFicheFacteurXVIII, getPersistedFicheFacteurXVIII(expectedFicheFacteurXVIII));
    }

    protected void assertPersistedFicheFacteurXVIIIToMatchUpdatableProperties(FicheFacteurXVIII expectedFicheFacteurXVIII) {
        assertFicheFacteurXVIIIAllUpdatablePropertiesEquals(
            expectedFicheFacteurXVIII,
            getPersistedFicheFacteurXVIII(expectedFicheFacteurXVIII)
        );
    }
}
