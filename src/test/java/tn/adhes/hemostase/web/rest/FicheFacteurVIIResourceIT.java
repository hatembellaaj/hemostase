...
/**
 * Integration tests for the {@link FicheFacteurVIIResource} REST controller.
 */
@IntegrationTest
@AutoConfigureMockMvc
@WithMockUser
class FicheFacteurVIIResourceIT {
    ...
    private static final Float DEFAULT_FACTEUR_VII = 1F;
    private static final Float UPDATED_FACTEUR_VII = 2F;

    private static final String DEFAULT_DOSAGE_AUTRES_FACTEURS = "AAAAAAAAAA";
    private static final String UPDATED_DOSAGE_AUTRES_FACTEURS = "BBBBBBBBBB";
    ...
    private static final String ENTITY_API_URL = "/api/fiche-facteur-viis";
    ...
    @Autowired
    private FicheFacteurVIIRepository ficheFacteurVIIRepository;
    ...
    @Autowired
    private MockMvc restFicheFacteurVIIMockMvc;

    private FicheFacteurVII ficheFacteurVII;

    private FicheFacteurVII insertedFicheFacteurVII;
     ...
     */
    public static FicheFacteurVII createEntity() {
        return new FicheFacteurVII()
            ...
            .facteurVII(DEFAULT_FACTEUR_VII)
            .dosageAutresFacteurs(DEFAULT_DOSAGE_AUTRES_FACTEURS)
     ...
     * if they test an entity which requires the current entity.
     */
    public static FicheFacteurVII createUpdatedEntity() {
        return new FicheFacteurVII()
            ...
            .facteurVII(UPDATED_FACTEUR_VII)
            .dosageAutresFacteurs(UPDATED_DOSAGE_AUTRES_FACTEURS)
    ...
    public void initTest() {
        ficheFacteurVII = createEntity();
    }

    @AfterEach
    public void cleanup() {
        if (insertedFicheFacteurVII != null) {
            ficheFacteurVIIRepository.delete(insertedFicheFacteurVII);
            insertedFicheFacteurVII = null;
        }
    }

    @Test
    @Transactional
    void createFicheFacteurVII() throws Exception {
        long databaseSizeBeforeCreate = getRepositoryCount();
        // Create the FicheFacteurVII
        FicheFacteurVIIDTO ficheFacteurVIIDTO = ficheFacteurVIIMapper.toDto(ficheFacteurVII);
        var returnedFicheFacteurVIIDTO = om.readValue(
            restFicheFacteurVIIMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ficheFacteurVIIDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            FicheFacteurVIIDTO.class
        );

        // Validate the FicheFacteurVII in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedFicheFacteurVII = ficheFacteurVIIMapper.toEntity(returnedFicheFacteurVIIDTO);
        assertFicheFacteurVIIUpdatableFieldsEquals(returnedFicheFacteurVII, getPersistedFicheFacteurVII(returnedFicheFacteurVII));

        insertedFicheFacteurVII = returnedFicheFacteurVII;
    }

    @Test
    @Transactional
    void createFicheFacteurVIIWithExistingId() throws Exception {
        // Create the FicheFacteurVII with an existing ID
        ficheFacteurVII.setId(1L);
        FicheFacteurVIIDTO ficheFacteurVIIDTO = ficheFacteurVIIMapper.toDto(ficheFacteurVII);
    ...
    void checkEtatCivilIsRequired() throws Exception {
        ...
        // set the field null
        ficheFacteurVII.setEtatCivil(null);

        // Create the FicheFacteurVII, which fails.
        FicheFacteurVIIDTO ficheFacteurVIIDTO = ficheFacteurVIIMapper.toDto(ficheFacteurVII);
    ...
    void checkServiceCliniqueIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurVII.setServiceClinique(null);
    ...
    void checkCouvertureSocialeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurVII.setCouvertureSociale(null);
    ...
    void checkDiagnosticIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        ficheFacteurVII.setDiagnostic(null);
    ...
    @Test
    @Transactional
    void getAllFicheFacteurVIIS() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);

        // Get all the ficheFacteurVIIList
        restFicheFacteurVIIMockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(ficheFacteurVII.getId().intValue())))
            ...
            .andExpect(jsonPath("$.[*].facteurVII").value(hasItem(DEFAULT_FACTEUR_VII.doubleValue())))
            .andExpect(jsonPath("$.[*].dosageAutresFacteurs").value(hasItem(DEFAULT_DOSAGE_AUTRES_FACTEURS)))
    ...
    @Test
    @Transactional
    void getFicheFacteurVII() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);

        // Get the ficheFacteurVII
        restFicheFacteurVIIMockMvc
            .perform(get(ENTITY_API_URL_ID, ficheFacteurVII.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(ficheFacteurVII.getId().intValue()))
            ...
            .andExpect(jsonPath("$.facteurVII").value(DEFAULT_FACTEUR_VII.doubleValue()))
            .andExpect(jsonPath("$.dosageAutresFacteurs").value(DEFAULT_DOSAGE_AUTRES_FACTEURS))
    ...
    @Test
    @Transactional
    void getNonExistingFicheFacteurVII() throws Exception {
        // Get the ficheFacteurVII
        restFicheFacteurVIIMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putExistingFicheFacteurVII() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the ficheFacteurVII
        FicheFacteurVII updatedFicheFacteurVII = ficheFacteurVIIRepository.findById(ficheFacteurVII.getId()).orElseThrow();
        // Disconnect from session so that the updates on updatedFicheFacteurVII are not directly saved in db
        em.detach(updatedFicheFacteurVII);
        updatedFicheFacteurVII
            .dossierNumber(UPDATED_DOSSIER_NUMBER)
            .ordreNumber(UPDATED_ORDRE_NUMBER)
            .indexNumber(UPDATED_INDEX_NUMBER)
            .prenom(UPDATED_PRENOM)
            ...
            .autreEvenement(UPDATED_AUTRE_EVENEMENT)
            .autreEvenementDetails(UPDATED_AUTRE_EVENEMENT_DETAILS);
        FicheFacteurVIIDTO ficheFacteurVIIDTO = ficheFacteurVIIMapper.toDto(updatedFicheFacteurVII);

        restFicheFacteurVIIMockMvc
            .perform(
                put(ENTITY_API_URL_ID, ficheFacteurVIIDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(ficheFacteurVIIDTO))
            )
            .andExpect(status().isOk());

        // Validate the FicheFacteurVII in the database
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertPersistedFicheFacteurVIIToMatchAllProperties(updatedFicheFacteurVII);
    }

    @Test
    @Transactional
    void putNonExistingFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithIdMismatchFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFicheFacteurVIIMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ficheFacteurVIIDTO)))
    ...
    @Test
    @Transactional
    void partialUpdateFicheFacteurVIIWithPatch() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);

        long databaseSizeBeforeUpdate = getRepositoryCount();

        // Update the ficheFacteurVII using partial update
        FicheFacteurVII partialUpdatedFicheFacteurVII = new FicheFacteurVII();
        partialUpdatedFicheFacteurVII.setId(ficheFacteurVII.getId());

        partialUpdatedFicheFacteurVII
            .dossierNumber(UPDATED_DOSSIER_NUMBER)
            .ordreNumber(UPDATED_ORDRE_NUMBER)
            .profession(UPDATED_PROFESSION)
            .etatCivil(UPDATED_ETAT_CIVIL)
        ...
        restFicheFacteurVIIMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedFicheFacteurVII.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(partialUpdatedFicheFacteurVII))
            )
            .andExpect(status().isOk());
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertFicheFacteurVIIUpdatableFieldsEquals(
            createUpdateProxyForBean(partialUpdatedFicheFacteurVII, ficheFacteurVII),
            getPersistedFicheFacteurVII(ficheFacteurVII)
        );
    }

    @Test
    @Transactional
    void fullUpdateFicheFacteurVIIWithPatch() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);
        ...
        assertFicheFacteurVIIUpdatableFieldsEquals(
            partialUpdatedFicheFacteurVII,
            getPersistedFicheFacteurVII(partialUpdatedFicheFacteurVII)
        );
    }

    @Test
    @Transactional
    void patchNonExistingFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
        ...
        restFicheFacteurVIIMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, ficheFacteurVIIDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(ficheFacteurVIIDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    @Test
    @Transactional
    void patchWithIdMismatchFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamFicheFacteurVII() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        ficheFacteurVII.setId(longCount.incrementAndGet());
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFicheFacteurVIIMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(ficheFacteurVIIDTO)))
            .andExpect(status().isMethodNotAllowed());
    ...
    @Test
    @Transactional
    void deleteFicheFacteurVII() throws Exception {
        // Initialize the database
        insertedFicheFacteurVII = ficheFacteurVIIRepository.saveAndFlush(ficheFacteurVII);

        long databaseSizeBeforeDelete = getRepositoryCount();

        // Delete the ficheFacteurVII
        restFicheFacteurVIIMockMvc
            .perform(delete(ENTITY_API_URL_ID, ficheFacteurVII.getId()).accept(MediaType.APPLICATION_JSON))
    ...
    protected long getRepositoryCount() {
        return ficheFacteurVIIRepository.count();
    }
    ...
    protected FicheFacteurVII getPersistedFicheFacteurVII(FicheFacteurVII ficheFacteurVII) {
        return ficheFacteurVIIRepository.findById(ficheFacteurVII.getId()).orElseThrow();
    }

    protected void assertPersistedFicheFacteurVIIToMatchAllProperties(FicheFacteurVII expectedFicheFacteurVII) {
        assertFicheFacteurVIIAllPropertiesEquals(expectedFicheFacteurVII, getPersistedFicheFacteurVII(expectedFicheFacteurVII));
    }

    protected void assertPersistedFicheFacteurVIIToMatchUpdatableProperties(FicheFacteurVII expectedFicheFacteurVII) {
        assertFicheFacteurVIIAllUpdatablePropertiesEquals(expectedFicheFacteurVII, getPersistedFicheFacteurVII(expectedFicheFacteurVII));
    }
}
