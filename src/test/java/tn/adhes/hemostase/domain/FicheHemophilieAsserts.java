...
public class FicheHemophilieAsserts {
    ...
    public static void assertFicheHemophilieUpdatableFieldsEquals(FicheHemophilie expected, FicheHemophilie actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getOrthopediques()).as("check orthopediques").isEqualTo(actual.getOrthopediques()))
            ...
            .satisfies(e -> assertThat(e.getCoudeDroit()).as("check coudeDroit").isEqualTo(actual.getCoudeDroit()))
            .satisfies(e -> assertThat(e.getCoudeGauche()).as("check coudeGauche").isEqualTo(actual.getCoudeGauche()))
            .satisfies(e -> assertThat(e.getGenouDroit()).as("check genouDroit").isEqualTo(actual.getGenouDroit()))
            .satisfies(e -> assertThat(e.getGenouGauche()).as("check genouGauche").isEqualTo(actual.getGenouGauche()))
            .satisfies(e -> assertThat(e.getChevilleDroite()).as("check chevilleDroite").isEqualTo(actual.getChevilleDroite()))
            .satisfies(e -> assertThat(e.getChevilleGauche()).as("check chevilleGauche").isEqualTo(actual.getChevilleGauche()))
            .satisfies(e -> assertThat(e.getEpauleDroite()).as("check epauleDroite").isEqualTo(actual.getEpauleDroite()))
            .satisfies(e -> assertThat(e.getEpauleGauche()).as("check epauleGauche").isEqualTo(actual.getEpauleGauche()))
            .satisfies(e -> assertThat(e.getPoignetDroit()).as("check poignetDroit").isEqualTo(actual.getPoignetDroit()))
            .satisfies(e -> assertThat(e.getPoignetGauche()).as("check poignetGauche").isEqualTo(actual.getPoignetGauche()))
            .satisfies(e -> assertThat(e.getHancheDroite()).as("check hancheDroite").isEqualTo(actual.getHancheDroite()))
            .satisfies(e -> assertThat(e.getHancheGauche()).as("check hancheGauche").isEqualTo(actual.getHancheGauche()))
