...
type PatientFormGroupContent = {
  ...
  medecinTraitant: FormControl<IPatient['medecinTraitant']>;
  serviceOrigine: FormControl<IPatient['serviceOrigine']>;
  biologisteResponsableDg: FormControl<IPatient['biologisteResponsableDg']>;
...
export class PatientFormService {
  createPatientFormGroup(patient: PatientFormGroupInput = { id: null }): PatientFormGroup {
    ...
    return new FormGroup<PatientFormGroupContent>({
      ...
      medecinTraitant: new FormControl(patientRawValue.medecinTraitant, {
        validators: [Validators.maxLength(30)],
      }),
      serviceOrigine: new FormControl(patientRawValue.serviceOrigine, {
        validators: [Validators.maxLength(30)],
      }),
      biologisteResponsableDg: new FormControl(patientRawValue.biologisteResponsableDg, {
        validators: [Validators.maxLength(30)],
      }),
