...
type RestOf<T extends IPatient | NewPatient> = Omit<T, 'dateNaissance' | 'dateEnregistrementRegistre'> & {
...
export class PatientService {
  ...
  protected convertDateFromClient<T extends IPatient | NewPatient | PartialUpdatePatient>(patient: T): RestOf<T> {
    return {
      ...
      dateEnregistrementRegistre: patient.dateEnregistrementRegistre?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restPatient: RestPatient): IPatient {
    return {
      ...
      dateEnregistrementRegistre: restPatient.dateEnregistrementRegistre ? dayjs(restPatient.dateEnregistrementRegistre) : undefined,
    };
  }
