...
import { sampleWithNewData, sampleWithRequiredData } from '../fiche-facteur-xviii.test-samples';

import { FicheFacteurXVIIIFormService } from './fiche-facteur-xviii-form.service';

describe('FicheFacteurXVIII Form Service', () => {
  let service: FicheFacteurXVIIIFormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(FicheFacteurXVIIIFormService);
  });

  describe('Service methods', () => {
    describe('createFicheFacteurXVIIIFormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup();
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            circHemorragique: expect.any(Object),
            precisionsCircHemorragique: expect.any(Object),
            decouverteFortuitePreop: expect.any(Object),
            precisionsDecouverteFortuite: expect.any(Object),
            jamaisSaignement: expect.any(Object),
            agePremierSigneJours: expect.any(Object),
            agePremierSigneMois: expect.any(Object),
            agePremierSigneAnnees: expect.any(Object),
            ...
            symptomePostAmygdalectomie: expect.any(Object),
            symptomePostAvulsionDentaire: expect.any(Object),
            symptomeChuteCordon: expect.any(Object),
            ...
            facteurDeficitaireAutre: expect.any(Object),
            tauxFacteurDeficitaireAutre: expect.any(Object),
            facteurSupplementaire1: expect.any(Object),
            tauxSupplementaire1: expect.any(Object),
            facteurSupplementaire2: expect.any(Object),
            tauxSupplementaire2: expect.any(Object),
            facteurSupplementaire3: expect.any(Object),
            tauxSupplementaire3: expect.any(Object),
      ...
      it('passing IFicheFacteurXVIII should create a new form with FormGroup', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup(sampleWithRequiredData);
    ...
    describe('getFicheFacteurXVIII', () => {
      it('should return NewFicheFacteurXVIII for default FicheFacteurXVIII initial value', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup(sampleWithNewData);

        const ficheFacteurXVIII = service.getFicheFacteurXVIII(formGroup) as any;

        expect(ficheFacteurXVIII).toMatchObject(sampleWithNewData);
      });

      it('should return NewFicheFacteurXVIII for empty FicheFacteurXVIII initial value', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup();

        const ficheFacteurXVIII = service.getFicheFacteurXVIII(formGroup) as any;

        expect(ficheFacteurXVIII).toMatchObject({});
      });

      it('should return IFicheFacteurXVIII', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup(sampleWithRequiredData);

        const ficheFacteurXVIII = service.getFicheFacteurXVIII(formGroup) as any;

        expect(ficheFacteurXVIII).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing IFicheFacteurXVIII should not enable id FormControl', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup();
      ...
      it('passing NewFicheFacteurXVIII should disable id FormControl', () => {
        const formGroup = service.createFicheFacteurXVIIIFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
