...
type RestOf<T extends IFicheHemophilie | NewFicheHemophilie> = Omit<
  T,
  | 'dateNaissance'
  | 'dateEnregistrementRegistre'
  | 'datePremierSigneClinique'
  | 'dateTestConfirmation'
  | 'dateDebutProphylaxie'
  | 'dateTestRecuperation'
  | 'dateDebutHemlibra'
  | 'dateDecouverteVHC'
  | 'dateDeces'
> & {
  ...
  dateDebutProphylaxie?: string | null;
  dateTestRecuperation?: string | null;
  dateDebutHemlibra?: string | null;
  dateDecouverteVHC?: string | null;
...
export class FicheHemophilieService {
  ...
  protected convertDateFromClient<T extends IFicheHemophilie | NewFicheHemophilie | PartialUpdateFicheHemophilie>(
    ...
    return {
      ...
      datePremierSigneClinique: ficheHemophilie.datePremierSigneClinique?.format(DATE_FORMAT) ?? null,
      dateTestConfirmation: ficheHemophilie.dateTestConfirmation?.format(DATE_FORMAT) ?? null,
      dateDebutProphylaxie: ficheHemophilie.dateDebutProphylaxie?.format(DATE_FORMAT) ?? null,
      dateTestRecuperation: ficheHemophilie.dateTestRecuperation?.format(DATE_FORMAT) ?? null,
      dateDebutHemlibra: ficheHemophilie.dateDebutHemlibra?.format(DATE_FORMAT) ?? null,
      dateDecouverteVHC: ficheHemophilie.dateDecouverteVHC?.format(DATE_FORMAT) ?? null,
      dateDeces: ficheHemophilie.dateDeces?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restFicheHemophilie: RestFicheHemophilie): IFicheHemophilie {
    return {
      ...
      dateEnregistrementRegistre: restFicheHemophilie.dateEnregistrementRegistre
        ...
        : undefined,
      datePremierSigneClinique: restFicheHemophilie.datePremierSigneClinique
        ? dayjs(restFicheHemophilie.datePremierSigneClinique)
        : undefined,
      dateTestConfirmation: restFicheHemophilie.dateTestConfirmation ? dayjs(restFicheHemophilie.dateTestConfirmation) : undefined,
      dateDebutProphylaxie: restFicheHemophilie.dateDebutProphylaxie ? dayjs(restFicheHemophilie.dateDebutProphylaxie) : undefined,
      dateTestRecuperation: restFicheHemophilie.dateTestRecuperation ? dayjs(restFicheHemophilie.dateTestRecuperation) : undefined,
      dateDebutHemlibra: restFicheHemophilie.dateDebutHemlibra ? dayjs(restFicheHemophilie.dateDebutHemlibra) : undefined,
      dateDecouverteVHC: restFicheHemophilie.dateDecouverteVHC ? dayjs(restFicheHemophilie.dateDecouverteVHC) : undefined,
      dateDeces: restFicheHemophilie.dateDeces ? dayjs(restFicheHemophilie.dateDeces) : undefined,
    };
  }
