...
type RestOf<T extends IFicheHemophilie | NewFicheHemophilie> = Omit<
  T,
  'dateTestConfirmation' | 'debutProphylaxie' | 'dateRecuperationFAH' | 'dateDebutHemlibra' | 'dateDecouverteVHC'
> & {
  dateTestConfirmation?: string | null;
  debutProphylaxie?: string | null;
  dateRecuperationFAH?: string | null;
...
export class FicheHemophilieService {
  ...
  protected convertDateFromClient<T extends IFicheHemophilie | NewFicheHemophilie | PartialUpdateFicheHemophilie>(
    ...
    return {
      ...
      debutProphylaxie: ficheHemophilie.debutProphylaxie?.format(DATE_FORMAT) ?? null,
      dateRecuperationFAH: ficheHemophilie.dateRecuperationFAH?.format(DATE_FORMAT) ?? null,
  ...
  protected convertDateFromServer(restFicheHemophilie: RestFicheHemophilie): IFicheHemophilie {
    return {
      ...
      debutProphylaxie: restFicheHemophilie.debutProphylaxie ? dayjs(restFicheHemophilie.debutProphylaxie) : undefined,
      dateRecuperationFAH: restFicheHemophilie.dateRecuperationFAH ? dayjs(restFicheHemophilie.dateRecuperationFAH) : undefined,
