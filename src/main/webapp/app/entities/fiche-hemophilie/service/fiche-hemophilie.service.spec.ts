...
const requireRestSample: RestFicheHemophilie = {
  ...
  dateDebutProphylaxie: sampleWithRequiredData.dateDebutProphylaxie?.format(DATE_FORMAT),
  dateTestRecuperation: sampleWithRequiredData.dateTestRecuperation?.format(DATE_FORMAT),
