...
type FicheHemophilieFormGroupContent = {
  ...
  decouverteFortuite: FormControl<IFicheHemophilie['decouverteFortuite']>;
  enqueteFamiliale: FormControl<IFicheHemophilie['enqueteFamiliale']>;
  explorationSyndrome: FormControl<IFicheHemophilie['explorationSyndrome']>;
...
export class FicheHemophilieFormService {
  createFicheHemophilieFormGroup(ficheHemophilie: FicheHemophilieFormGroupInput = { id: null }): FicheHemophilieFormGroup {
    ...
    return new FormGroup<FicheHemophilieFormGroupContent>({
      ...
      decouverteFortuite: new FormControl(ficheHemophilieRawValue.decouverteFortuite),
      enqueteFamiliale: new FormControl(ficheHemophilieRawValue.enqueteFamiliale),
      explorationSyndrome: new FormControl(ficheHemophilieRawValue.explorationSyndrome),
