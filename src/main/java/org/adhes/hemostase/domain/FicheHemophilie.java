...
public class FicheHemophilie implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "ordre_number", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "degre_parente_consanguins", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "degre_parente_cas_similaires", length = 50)
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "circonstance_hematome_superficiel")
    private TypeManifestation circonstanceHematomeSuperficiel;

    @Size(max = 50)
    @Column(name = "siege_hematome_superficiel", length = 50)
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "circonstance_hematome_psoas")
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "type_hemorragies_cutaneo_muqueuses")
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "type_hemorragie_visceres")
    ...
    @Size(max = 50)
    @Column(name = "examen_lesion_hemorragie_visceres", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "type_intervention_chirurgicale", length = 50)
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "circonstance_accidents_hemorragiques_graves")
    ...
    @Size(max = 50)
    @Column(name = "cause_prise_en_charge", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "posologie_iti", length = 50)
    private String posologieITI;

    @Size(max = 50)
    @Column(name = "duree_iti", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "cause_non_observance_iti", length = 50)
    ...
    @Size(max = 50)
    @Column(name = "charge_virale_vhc", length = 50)
    ...
    public FicheHemophilie circonstanceHematomeSuperficiel(TypeManifestation circonstanceHematomeSuperficiel) {
    ...
    public FicheHemophilie circonstanceHematomePsoas(TypeManifestation circonstanceHematomePsoas) {
    ...
    public FicheHemophilie typeHemorragiesCutaneoMuqueuses(TypeHemorragie typeHemorragiesCutaneoMuqueuses) {
    ...
    public FicheHemophilie typeHemorragieVisceres(TypeHemorragieVisceres typeHemorragieVisceres) {
    ...
    public FicheHemophilie circonstanceAccidentsHemorragiquesGraves(AccidentsGravesType circonstanceAccidentsHemorragiquesGraves) {
