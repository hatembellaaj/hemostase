...
/**
 * A DTO for the {@link tn.adhes.hemostase.domain.FicheFacteurVII} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FicheFacteurVIIDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FicheFacteurVIIDTO)) {
            return false;
        }

        FicheFacteurVIIDTO ficheFacteurVIIDTO = (FicheFacteurVIIDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, ficheFacteurVIIDTO.id);
    }
