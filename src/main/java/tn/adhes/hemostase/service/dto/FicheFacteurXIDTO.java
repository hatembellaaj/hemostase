...
/**
 * A DTO for the {@link tn.adhes.hemostase.domain.FicheFacteurXI} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FicheFacteurXIDTO implements Serializable {
    ...
    public String getPrecisionSyndromeHemorragique() {
        return precisionSyndromeHemorragique;
    }
    ...
    public String getPrecisionDecouverteFortuite() {
        return precisionDecouverteFortuite;
    }
    ...
    public String getAutresFacteursDosageDescription() {
        return autresFacteursDosageDescription;
    }
    ...
    public Boolean getHemorragiePostTraumatique() {
        return hemorragiePostTraumatique;
    }
    ...
    public Integer getFrequenceHemorragiePostTraumatique() {
        return frequenceHemorragiePostTraumatique;
    }
    ...
    public Boolean getHematomeTissusMousProfonds() {
        return hematomeTissusMousProfonds;
    }
    ...
    public TypeManifestation getTypeHematomeTissusMousProfonds() {
        return typeHematomeTissusMousProfonds;
    }
    ...
    public Integer getFrequenceHematomeTissusMousProfonds() {
        return frequenceHematomeTissusMousProfonds;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FicheFacteurXIDTO)) {
            return false;
        }

        FicheFacteurXIDTO ficheFacteurXIDTO = (FicheFacteurXIDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, ficheFacteurXIDTO.id);
    }
