...
public class Patient implements Serializable {
    ...
    @Size(max = 30)
    @Column(name = "nom_jeune_fille", length = 30)
    ...
    @Size(max = 30)
    @Column(name = "autre_origine", length = 30)
    ...
    @Size(max = 30)
    @Column(name = "prenom_pere", length = 30)
    private String prenomPere;

    @Size(max = 30)
    @Column(name = "profession_pere", length = 30)
    private String professionPere;

    @Size(max = 30)
    @Column(name = "nom_prenom_mere", length = 30)
    private String nomPrenomMere;

    @Size(max = 30)
    @Column(name = "profession_mere", length = 30)
    private String professionMere;

    @Size(max = 30)
    @Column(name = "medecin_traitant", length = 30)
    private String medecinTraitant;

    @Size(max = 30)
    @Column(name = "service_origine", length = 30)
    private String serviceOrigine;

    @Size(max = 30)
    @Column(name = "biologiste_responsable_dg", length = 30)
    ...
    @Size(max = 30)
    @Column(name = "autre_diagnostic", length = 30)
    ...
    public Patient medecinTraitant(String medecinTraitant) {
    ...
    public Patient serviceOrigine(String serviceOrigine) {
    ...
    public Patient biologisteResponsableDg(String biologisteResponsableDg) {
